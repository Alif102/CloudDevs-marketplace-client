...
const Route404 = () => {
    return (
        <div>
            ...
            <Link
            className="w-full mt-4 py-3 px-4 rounded-full bg-gradient-to-r from-[#2c3e50] to-[#4ca1af] text-white text-center font-semibold text-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
          >
            Back To Home
          </Link>
            </div>
