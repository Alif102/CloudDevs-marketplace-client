...
const Testimonials = () => {
  return (
    <div className="w-full md:w-[85%] mx-auto bg-gradient-to-r from-[#2c3e50] to-[#4ca1af] pb-20 pt-16 my-10">
      <p className="text-xl font-medium text-center mb-10">Testimonials</p>
      <Swiper
      ...
      >
        <SwiperSlide>
          <div className="flex flex-col gap-4 rounded-lg p-3 bg-white pb-10">
            <p className="text-[#2c3e50]enter p-4 rounded-lg">
              Cloud Devs transformed my job search journey. With their
              ...
              made all the difference. I can nott recommend Cloud Devs enough!
            </p>
        ...
        <SwiperSlide>
          <div className="flex flex-col gap-4 rounded-lg p-3 bg-white pb-10">
            <p className="text-[#2c3e50]enter p-4 rounded-lg">
              ...
              discovered Cloud Devs. Their extensive listings and easy-to-navigate
              website provided me with numerous opportunities. I am grateful to
              the Cloud Devs team for helping me find my ideal role.
            </p>
            <div className="flex flex-col items-center">
              <img
                className="w-12 h-12 rounded-full"
        ...
        <SwiperSlide>
          <div className="flex flex-col gap-4 rounded-lg p-3 bg-white pb-10">
            <p className="text-[#2c3e50]enter p-4 rounded-lg">
              Cloud Devs is my go-to for job hunting. Their professional approach
              and robust job database gave me the edge in my career. The support
              and resources available are truly exceptional. Thank you, Cloud Devs,
        ...
        <SwiperSlide>
          <div className="flex flex-col gap-4 rounded-lg p-3 bg-white pb-10">
            <p className="text-[#2c3e50]enter p-4 rounded-lg">
              Cloud Devs is a game-changer in the job market. Their intuitive
              ...
              Cloud Devs, you are the best. All the best. Keep gonig like that.
            </p>
            <div className="flex flex-col items-center">
              <img
                className="w-12 h-12 rounded-full"
        ...
        <SwiperSlide>
          <div className="flex flex-col gap-4 rounded-lg p-3 bg-white pb-10">
            <p className="text-[#2c3e50]enter p-4 rounded-lg">
              Cloud Devs took the stress out of my job search. The seamless
        ...
        <SwiperSlide>
          <div className="flex flex-col gap-4 rounded-lg p-3 bg-white pb-10">
            <p className="text-[#2c3e50]enter p-4 rounded-lg">
              Cloud Devs exceeded my expectations. The user interface is intuitive,
              and the wealth of information available is unmatched. Cloud Devs
              guided me to a career path I did not even know existed. If you are
              serious about finding the right job, Cloud Devs is the place to be
            </p>
            <div className="flex flex-col items-center">
              <img
                className="w-12 h-12 rounded-full"
